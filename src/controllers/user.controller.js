...
import { uploadOnCloudinary, uploadOnCloudinary } from "../utils/cloudinary.utils.js";
...
const getCurrentUser = asyncHandler(async(req,res) => {
    ...
    .json(new ApiResponse(
        200,
        req.user,
        "current user if fetched successfully"
    ))
})
...
const updateAccountDetail = asyncHandler(async(req,res) => {
    ...
    if(!(fullname || email)){
        throw new ApiError(400,"You are not a user");
    }
    ...
    return res
    .status(200)
    .json(new ApiResponse(200, user, "Accounts details are updated"))
})
...
const updateUserAvatar = asyncHandler(async(req,res) => {
    ...
    return res 
    .status(200)
    .json(new ApiResponse(200,user,"avatar of the user is successfully updated"))
...
const updateUserCoverImage = asyncHandler(async(req,res) => {
    ...
    return res 
    .status(200)
    .json(new ApiResponse(200,user,"coverImage of the user is successfully updated"))
})
